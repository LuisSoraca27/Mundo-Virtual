...
// En otra parte del código donde usas "set", deberías usar "setChecked" en su lugar
    ...
    const handleBuy = () => {
        setPurchase(true);
        dispatch(buyProductThunk(product.id, type, email, subject))
            .finally(() => {
                setPurchase(false);
                onClose();
                reCharge();
        ...
        >
            <div className="container_modal_profile">
                <div className="container_img">
                    <img src={product.imgCombos ? product.imgCombos[0].urlImagen :
                          product.imgCourses ? product.imgCourses[0].urlImagen :
                          product.imgLicenses ? product.imgLicenses[0].urlImagen : ''} 
                         width={'80%'} 
                         alt={product?.name} />
                </div>
                <div className="container_info">
                    ...
                    <div className="profile">
                       ...
                       <span>Descripción de producto:</span>
                        <p style={{ fontSize: '17px', margin: '5px' }}>{product.description}</p>
