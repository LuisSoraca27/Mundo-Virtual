...
form.append('profiles', JSON.stringify(profiles));
        ...
        dispatch(createComboThunk(form))
            .finally(() => {
                reCharge();
                onClose();
                setProcesing(false);
...
/>
    ...
    onChange={(e) => handleInputChange({ target: { name: 'categoryId', value: e.value } }, index)}
...
/>
                        ...
                        <br />
                        <Button label="Añadir Perfil" onClick={addAccordionItem}
                           icon="pi pi-plus"
                        >
                        </Button>
                    </div>
